...
% Detect FAST features with higher threshold to reduce noise
points1 = detectFASTFeatures(I1_enhanced, 'MinContrast', 0.2);
points2 = detectFASTFeatures(I2_enhanced, 'MinContrast', 0.2);
...
function enhanced = enhanceImageWithFourier(img)
    % Use histogram equalization for better enhancement
    enhanced = histeq(img);
end